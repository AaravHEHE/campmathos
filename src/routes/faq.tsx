  ...
  head: () => ({
    meta: [
      { title: "FAQ — Mathos summer camp" },
      {
        name: "description",
        content:
          "Answers to the most common questions about Mathos: cost, schedule, attendance, drop-off, materials, prerequisites, the Easy Python track, and how to register.",
      },
      { property: "og:title", content: "FAQ — Mathos summer camp" },
      {
        property: "og:description",
        content:
          "Cost, schedule, attendance, drop-off, materials, prerequisites, Easy Python, and how to register.",
      },
    ],
  }),
});
...
const faqs: { q: string; a: string }[] = [
  ...
  },
  {
    ...
    a: "A pencil and a notebook are recommended. A calculator can be helpful but isn't required — instructors will assist whenever it's needed. For the Easy Python track, a computer is required.",
  },
  {
  ...
  {
    q: "Are there any prerequisites for the Easy Python track?",
    a: "There are no prerequisites — beginners are welcome. The only requirement is bringing a computer to use during the sessions.",
  },
  {

...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { title: "MathOs — Free hybrid summer applied math camp" },
      { name: "description", content: "Sign up for MathOs — a free hybrid summer math camp, in person or live over Zoom, taught by the math team." },
      ...
      { property: "og:description", content: "Sign up for MathOs — a free hybrid summer math camp, in person or live over Zoom, taught by the math team." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:title", content: "MathOs — Free hybrid summer applied math camp" },
      { name: "twitter:description", content: "Sign up for MathOs — a free hybrid summer math camp, in person or live over Zoom, taught by the math team." },
